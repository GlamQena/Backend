...
let seedData = [
  //skincare products
  {
    ...
    name: "Dermacy تونر مرطب حليبي 150 مل",
    description:
      "تونر حليبي لجميع أنواع البشرة، ينقي خلايا البشرة ويقلل من حجم المسام.",
    price: 293,
    stock: 20,
    images: [
  ...
  },
  {
    owner_store_id: "{id}",
    category_id: "69e387b312d268b6bb3b69db",
    name: "Kolagra تونر تفتيح للوجه",
    description:
      "غني بفيتامين E، ألفا أربوتين والنياسيناميد لتفتيح البشرة.",
    brand: "Kolagra",
    price: 122,
    stock: 15,
    images: [
  ...
  },
  {
    owner_store_id: "{id}",
    category_id: "69e387b312d268b6bb3b69db",
    name: "Kolagra تونر مضاد لللمعان",
    description: "غني بالنياسيناميد وحمض الجليكوليك، يزيل اللمعان.",
    price: 105,
    stock: 12,
    images: [
  ...
  },
  {
    owner_store_id: "{id}",
    category_id: "69e387b312d268b6bb3b69db",
    name: "Alejon تونر للوجه",
    price: 260,
    description: "يحتوي على حمض الجليكوليك، النياسيناميد وزيت شجرة الشاي للتنظيف العميق.",
    stock: 10,
    images: [
  ...
  },
  {
    owner_store_id: "{id}",
    category_id: "69e387b312d268b6bb3b69db",
    name: "Tersus محلول تونر حمض الجليكوليك 220 مل",
    price: 207,
    description: "محلول حمض الجليكوليك 8٪ لإزالة خلايا الجلد الميتة وتقليل التجاعيد الدقيقة.",
    stock: 8,
    images: [
  ...
  },
  {
    ...
    name: "Moist-1 تونر",
    price: 180,
    description: "تونر للبشرة الجافة والعادية، يزيل الشوائب والمكياج.",
    stock: 25,
    images: [
  ...
  },
  {
    ...
    name: "Jamira تونر",
    price: 150,
    description: "تونر للبشرة الدهنية والمعرضة لحب الشباب، يحتوي على حمض الساليسيليك وزيت شجرة الشاي.",
    stock: 20,
    images: [
  ...
  },
  {
    owner_store_id: "{id}",
    category_id: "69e387b312d268b6bb3b69db",
    name: "Vichy Normaderm منظف مكثف للبشرة الدهنية 200 مل",
    price: 688,
    description: "جل منقي مكثف للبشرة الدهنية والمعرضة لحب الشباب.",
    stock: 15,
    images: [
      "uploads/vichi1.avif",
  ...
  },
  {
    owner_store_id: "{id}",
    category_id: "69e387b312d268b6bb3b69db",
    name: "StarVille جل منظف للوجه 400 مل",
    price: 210,
    description: "منظف مضاد للبكتيريا للبشرة المختلطة والدهنية.",
    stock: 30,
    images: [
  ...
  },
  {
    owner_store_id: "{id}",
    category_id: "69e387b312d268b6bb3b69db",
    name: "Dermacy منظف الوجه الرغوي",
    price: 266,
    description: "منظف رغوي لطيف للبشرة الحساسة والجافة.",
    stock: 20,
    images: [
  ...
  },
  {
    owner_store_id: "{id}",
    category_id: "69e387b312d268b6bb3b69db",
    name: "Clearsal منظف لطيف مضاد لحب الشباب",
    price: 198,
    description: "منظف لطيف مصمم للبشرة المعرضة لحب الشباب.",
    stock: 25,
    images: [
  ...
  },
  {
    owner_store_id: "{id}",
    category_id: "69e387b312d268b6bb3b69db",
    name: "Dr. Elvish منظف مهدئ بالسيكا 200 مل",
    price: 235,
    description: "منظف مهدئ بمستخلص السيكا، مثالي للبشرة الحساسة.",
    stock: 12,
    images: [
  ...
  },
  {
    owner_store_id: "{id}",
    category_id: "69e387b312d268b6bb3b69db",
    name: "CeraVe كريم مرطب",
    price: 420,
    description: "كريم مرطب غني للبشرة الجافة إلى شديدة الجفاف",
    stock: 15,
    images: [
  ...
  },
  {
    owner_store_id: "{id}",
    category_id: "69e387b312d268b6bb3b69db",
    name: "Blanki كريم مرطب",
    price: 350,
    description: "مرطب متخصص لبشرة الأطفال، لطيف ومغذي",
    stock: 20,
    images: [
  ...
  },
  {
    ...
    price: 544,
    description: "كريم مرطب مضاد للشوائب للبشرة المعرضة لحب الشباب",
    stock: 10,
    images: [
  ...
  },
  {
    owner_store_id: "{id}",
    category_id: "69e387b312d268b6bb3b69db",
    name: "Laylac كريم ترطيب",
    price: 515,
    description: "تركيبة ترطيب متقدمة لإصلاح حاجز البشرة",
    stock: 12,
    images: [
  ...
  },
  {
    ...
    price: 450,
    description: "مرطب خفيف الوزن مناسب للاستخدام اليومي",
    stock: 18,
    images: [
      "uploads/sesh1.avif",
      "uploads/sesh-2.avif",
  ...
  },
  {
    owner_store_id: "{id}",
    category_id: "69e387b312d268b6bb3b69db",
    name: "Shine & White سيروم",
    price: 390,
    description: "سيروم مضيء لإشراقة مشرقة للبشرة.",
    stock: 15,
    images: [
  ...
  },
  {
    owner_store_id: "{id}",
    category_id: "69e387b312d268b6bb3b69db",
    name: "Dermaelle سيروم معزز للبشرة بالإبر الدقيقة",
    price: 520,
    description: "سيروم ريتينول مضاد للشيخوخة لتحسين نسيج الجلد وتقليل الخطوط الدقيقة.",
    stock: 8,
    images: [
...
const owner_store_id = "69e9085493835e8e70d675ea"; //consider as ObjectId not string despite these quotes
// makeup For you (abear) => 69d0ddd76d08a00080101c4a
// Semon's Market (semon) => 6a0095cf131a41a01b0c20a4
